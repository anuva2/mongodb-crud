...
> `docker-compose.yml` starts two containers: the Node.js app and a MongoDB service.
> 
> **Storage optimization**: The app container is ~52MB (multi-stage build with Alpine Linux).
> MongoDB container is ~700MB (includes full database engine). Data persists in named volume.
